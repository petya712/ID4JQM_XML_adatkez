...
public class XmlToHtmlTransformer2 {

	public static void main(String[] args) throws SAXException, IOException, ParserConfigurationException,
			TransformerFactoryConfigurationError, TransformerException {
		transform("autokID4JQM.out.xml", "autokID4JQM.xsl");
	}

	public static void transform(final String xml, final String xslt) throws SAXException, IOException,
			ParserConfigurationException, TransformerFactoryConfigurationError, TransformerException {

		ClassLoader classloader = XmlToHtmlTransformer2.class.getClassLoader();
		...
		// write to file
		File file = new File("autokID4JQM.html");
		if (!file.exists()) {
			file.createNewFile();
		}
