...
public class DOMReadID4JQM {
    public static void main(String[] args) throws SAXException, IOException, ParserConfigurationException {
        ...
        /*
            ...
            Minden csoporthoz érve a csoport ID-t átadva meghívja a diák és a tanár kiíró függvényeket.        
        */
        for (int i = 0; i < nList.getLength(); i++) {
            ...
            if (nNode.getNodeType() == Node.ELEMENT_NODE) {
                ...
                System.out.println("\nA " + nev + " csoport tanárai:\n");
                ListTanar(doc, id);

                System.out.println("\nA " + nev + " csoport diákjai:\n");
                ListDiak(doc, id);
            }
        }
    }

    public static void ListDiak (Document doc, String csoportid) {
    ...
    public static void ListTanar (Document doc, String csoportid) {
